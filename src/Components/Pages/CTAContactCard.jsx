  ...
  return (
    <div className="bg-green-600 text-white mt-12 rounded-xl max-w-5xl mx-auto px-6 md:px-14 py-10 flex flex-col-reverse md:flex-row justify-between items-center gap-8">
      ...
      <div className="max-w-md text-center md:text-left">
        <h3 className="text-xl md:text-2xl font-bold mb-2">New projects in your mind?</h3>
      ...
      {/* Thinking Guy Image with animation */}
      <motion.div
        className="w-[200px] h-[200px] md:w-[150px] md:h-[150px] flex-shrink-0"
