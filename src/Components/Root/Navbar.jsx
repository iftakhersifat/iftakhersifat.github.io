...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 max-w-5xl mx-auto px-6 py-3 bg-white/80 dark:bg-black/70 backdrop-blur-lg rounded-xl shadow-md flex items-center justify-between">
